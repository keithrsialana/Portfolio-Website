		...
		<div className="container-fluid">
			...
			<div className="row text-center">
				...
				<div className="col-md-6">
					<ArticleSection
						title="History"
						content="As a child, Keith grew up super easy-going and had a friendly
						approach towards interacting with others. Whilst having an interest
						in Sports and Arts, Keith's interests had always leaned more towards
						technology. Since at the age of 4, Computers and video games have
						always been a part of Keith's life. Keith's interest in programming
						started in highschool when he took both Computer Engineering and
						Computer Sciences courses. Since then, he's taught himself different
						languages like Python and Javascript while learning Visual Basic and
						Assembly in highschool."
					/>
					<ArticleSection
						title="Post-Secondary"
						content="After highschool, he continued to pursue the tech field by taking
					...
					<ArticleSection
						title="Field-Work"
						content="After the second year, he was then hired as a co-op student with
						Linamar Corp. doing Desktop Support Technician work for 8 months,
						then moved to 4 more months of Application Development with the same
						company. After completing his co-op year, he graduated college with
						an Ontario College Advanced Diploma with Distinction at 2022 with an
						overall program 3.7 GPA and a 3.9 GPA for his final year."
					/>
					<ArticleSection
						title="Current"
						content="As of September 2024, Keith has signed up and is enrolled in EdX's
