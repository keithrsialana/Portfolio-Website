    ...
    <div className="resume">
      ...
      <div className="container mt-3">
        ...
        <p>
          <ul>
            <li>
              Improved UI design using CSS, increasing user satisfaction by 20%
              based on internal feedback.
            </li>
            <li>
              Enhanced multilingual support, expanding accessibility for
              international users.
            </li>
            <li>
              Collaborated with the team using Azure DevOps for version control,
              task tracking, and deployment planning.
            </li>
          </ul>
        </p>
        <h4 className="label text-mustard">
        ...
        <p>
          <ul>
            <li>
              Provided technical support to 100+ users, resolving hardware and
              software issues efficiently.
            </li>
            <li>
              Automated routine tasks with PowerShell and Bash scripts, reducing
              manual workload for technicians.
            </li>
            <li>
              Created a custom Windows 11 installation USB with pre-installed
              company software, streamlining device setup.
            </li>
          </ul>
        </p>
        <h2 className="text-center bg-tomato display-6 pb-2">
